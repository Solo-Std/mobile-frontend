...
import mobile.umn.mobileapp.adapter.GeneralManagerListAdapter;
...
public class GeneralManagerActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.general_manager_recycler_view);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.general_manager, menu);
        return true;
    }
